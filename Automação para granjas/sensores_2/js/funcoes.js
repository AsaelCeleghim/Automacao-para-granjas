                ...
                function busca_temperaturas() {
                    ...
                    xhttp.open("GET", "./php/temperaturas.php", true);
                    xhttp.send();
                }

                // Função para exibir os dados na tabela
                function mostrarDados5(data) {
                    var table = document.getElementById("tabela_temperaturas");
                    // Limpa a tabela antes de atualizá-la
                   
                    // Adiciona os novos dados à tabela
                    data.forEach(function(lista5) {
                        // var row1 = table.insertRow();
                        document.getElementById("t1").innerHTML = lista5.t1 + " °C";
                        document.getElementById("t2").innerHTML = lista5.t2 + " °C";
                        document.getElementById("t3").innerHTML = lista5.t3 + " °C";
                        document.getElementById("t4").innerHTML = lista5.t4 + " °C";
                        document.getElementById("t5").innerHTML = lista5.t5 + " °C";
                        document.getElementById("t6").innerHTML = lista5.t6 + " °C";
                        document.getElementById("t7").innerHTML = lista5.t7 + " °C";
                    });
                }
                 //////////////////////////////////////////////////////////////////////////////////
                 function busca_silos() {
                    var xhttp = new XMLHttpRequest();
                    xhttp.onreadystatechange = function() {
                        if (this.readyState == 4 && this.status == 200) {
                            var data = JSON.parse(this.responseText);
                    ...
                    xhttp.open("GET", "./php/silos.php", true);
                    xhttp.send();
                }

                // Função para exibir os dados na tabela
                function mostrarDados5(data) {
                    var table = document.getElementById("tabela_silos");
                    // Limpa a tabela antes de atualizá-la
                   
                    // Adiciona os novos dados à tabela
                    data.forEach(function(lista6) {
                        // var row1 = table.insertRow();
                        document.getElementById("silo1").innerHTML = lista6.silo1 + " Kg";
                        document.getElementById("silo2").innerHTML = lista6.silo2 + " Kg";
                    });
                }
                ...
                busca_temperaturas();
                setInterval(busca_temperaturas, 5000);

                busca_silos();
                setInterval(busca_silos, 5000);
