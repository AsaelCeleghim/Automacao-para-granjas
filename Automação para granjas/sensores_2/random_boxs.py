...
def temperaturas():
    ...
    while True:
        ...
        try:
            ...
            mycursor = mydb.cursor()
            sql = "delete from temperaturas"
            mycursor.execute(sql)
            # Inserir os valores no banco de dados usando parâmetros para prevenir injeção SQL
            sql = "INSERT INTO temperaturas (t1, t2, t3, t4, t5 ,t6, t7) VALUES (%s, %s, %s, %s, %s, %s, %s)"
            val = (t1, t2, t3, t4, t5 ,t6, t7)
            mycursor.execute(sql, val)
...
def silos():
    ...
    def silo1():
        # Gerar um valor aleatório entre 300 e 10000
        return round(random.uniform(0, 999), 1)
    ...
    while True:
        ...
        try:
            ...
            mycursor = mydb.cursor()
            sql = "delete from silos"
            mycursor.execute(sql)
            # Inserir os valores no banco de dados usando parâmetros para prevenir injeção SQL
            sql = "INSERT INTO silos (silo1, silo2) VALUES (%s, %s)"
            val = (silo1, silo2)
            mycursor.execute(sql, val)
